    ...
    def test_sandbox_spec_uses_resolved_file_permissions(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                {"action": "deny", "path": "/workspace/.env.local"},
                {"action": "deny", "path": "/workspace/.env.development"},
                {"action": "deny", "path": "/workspace/.env.test"},
                {"action": "deny", "path": "/workspace/.env.production"},
                {"action": "deny", "path": "/workspace/.npmrc"},
                {"action": "deny", "path": "/workspace/.pypirc"},
                {"action": "deny", "path": "/workspace/.netrc"},
                {"action": "deny", "path": "/workspace/.aws"},
                {"action": "deny", "path": "/workspace/.gcp"},
                {"action": "deny", "path": "/workspace/.azure"},
                {"action": "deny", "path": "/workspace/.ssh"},
                {"action": "deny", "path": "/workspace/.git-credentials"},
